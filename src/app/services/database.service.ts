...
export class DatabaseService {
    ...
    addInvoice(name, rate, tax) {
        let data = [name, rate, tax]
        return this.database.executeSql('INSERT INTO Invoice (name, rate, deductableTaxPercentage) VALUES (?, ?, ?)', data).then((data: any) => {
            this.loadInvoices();
